...
int main()
{
    ...
    while (1) {
        char input[80];
        int i, j, j2, in = 1, end = 0, fl1 = 0, com = 0, err1 = 0, err3 = 0,
                      err4 = 0, err6 = 1, err7 = 0, XtoY = 0;
        ...
        if (fl1 == 1) {
            if (input[end - 1] != ')') {
                printf("Error at column %d: expected ')' in the end of "
                       "function\n",
                       end);
                return 0;
            }
        ...
        if (err1 == 0 && err3 == 0 && err4 == 0 && err6 == 0) {
            ...
            if (r < 0 || r == 0) {
                printf("Error : token R must be more than zero \n");
                return 0;
            }
